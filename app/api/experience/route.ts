...
const getExpHandler = async (req: ExtendedNextRequest): Promise<NextResponse> => {
    ...
    // userId is guaranteed to exist by the loginRequired middleware
...
export const GET = catchAsync(async (req, context) => {
    ...
    return chainMiddleware(getMiddlewares, getExpHandler)(req, context);
});