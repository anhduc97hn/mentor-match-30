    ...
    <Card sx={{ display: "flex", flexDirection: "column", p: 2 }}>
      ...
      <Stack direction="row" spacing={4} alignItems="center" sx={{ mb: 3 }}>
        ...
        <Stack>
          ...
          {session.status === "accepted" && daysUntilSession > 0 && ( // Added check for days > 0
      ...
      >
        ...
        {session.status === "accepted" && (
          <Button
            size="large"
            component={Link} // Use MUI Link component for external link
            href={session.gEventLink} // Use href for external links
            target="_blank"
          >
            Google Meet Link
          </Button>
